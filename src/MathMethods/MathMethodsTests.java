...
public class MathMethodsTests {
	...
	public void testLcm() {
		...
		assertEquals(8L, MathMethods.lcm(2, 4));
	...
	public void testPower() {
		...
		assertEquals(1.0, MathMethods.power(1.0, 1000000000), 0.001);
		assertEquals(4.0, MathMethods.power(2.0, 2), 0.001);
		assertEquals(9.86, MathMethods.power(Math.PI, 2), 0.001);
		assertEquals(1096.63, MathMethods.power(Math.E, 7), 0.001);
		assertEquals(1.2528328e25, MathMethods.power(123.45, 12), 0.001);
	}
	...
	public void testRoot() {
		...
		assertEquals(2.14, MathMethods.root(8, 456.02, 0.001), 0.001);
	}
	
	@Test
	public void testSqrt() {
		assertEquals(0.0, MathMethods.sqrt(0.0, 0.001), 0.001);
		assertEquals(2.0, MathMethods.sqrt(4.0, 0.001), 0.001);
		assertEquals(10.0, MathMethods.sqrt(100.0, 0.001), 0.001);
		assertEquals(1.64, MathMethods.sqrt(Math.E, 0.001), 0.001);
	}
